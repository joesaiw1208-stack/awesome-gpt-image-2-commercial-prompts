...
这个页面用于记录本仓库新增案例背后的公开参考来源。

这里不会直接照搬社区 prompt 原文，而是把常见思路转译成我们自己的统一结构：
...
- [Sourceful：用产品图生成落地页](https://www.sourceful.com/x/create-a-landing-page-from-your-product-image-with-this-gpt-image-prompt/)
...
- [高端编辑感书架场景](../prompts/home-living/luxury-editorial-bookshelf-scene.md)

### 社媒广告、轮播系统与竖版投放方向

- [X 创意广告规格](https://business.x.com/en/help/campaign-setup/creative-ad-specifications)
- [X 广告互动形式](https://business.x.com/en/advertising/campaign-types/engagements)
