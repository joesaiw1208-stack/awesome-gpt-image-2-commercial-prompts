# Community Commercial Inspirations

This page tracks public references that informed new prompt directions in this repo.

We do **not** copy community prompts verbatim. We translate recurring ideas into this repo's own structure:
...
### Landing Page and Website Mockups

- [Sourceful: create a landing page from your product image](https://www.sourceful.com/x/create-a-landing-page-from-your-product-image-with-this-gpt-image-prompt/)
...
- [Luxury Editorial Bookshelf Scene](../prompts/home-living/luxury-editorial-bookshelf-scene.md)

### Social Ads, Carousel Systems, and Vertical Formats

- [X creative ad specifications](https://business.x.com/en/help/campaign-setup/creative-ad-specifications)
- [X ads engagements overview](https://business.x.com/en/advertising/campaign-types/engagements)
